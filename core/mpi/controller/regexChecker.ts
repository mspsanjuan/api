...
const RegexCheckerLog = new Logger({ connection: Connections.logs, module: 'jobs', application: 'andes', type: 'regexChecker' });
...
export async function regexChecker(done) {
    const regexLog = RegexCheckerLog.startTrace();
    try {
